export const postStyles = {
  flexStart: 'flex justify-start items-center pt-[10px] w-full',
  wrapper: 'w-full py-[10px] px-[20px] bg-card rounded-[8px] mb-[30px]',
  likeCommentWrapper: 'transition-all duration-75 hover:scale-[1.05]',
  description: 'text-white text-[14px] mb-[10px]',
  friendWrapper: 'flex justify-between items-center mb-[15px] w-full',
